...
class PayPalPaymentController extends Controller
{
	...
	public function creatPayment(Request $request)
    {
		...
		*/
			...
			$redirectUrls->setReturnUrl("http://perfectlinkfitness.com/execute-payment?subtotalAmount=".$subtotalAmount."&orderId=".$order_id."&shippingId=".$shipping_id."&userId=".$user_id)
