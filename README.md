...
## Project Structure
    ...
    ├── perfect_links_fitne_31795  # Django project configurations
...
1. Clone this repo and `cd perfect_links_fitne_31795`
...
2. Clone this repo and `cd perfect_links_fitne_31795`
