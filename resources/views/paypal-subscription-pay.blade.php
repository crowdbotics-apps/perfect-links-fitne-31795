        ...
        <div class="flex-center position-ref full-height">
            <div class="content">
				...
				<form method="post" action="http://perfectlinkfitness.com/api/subscription-payment">
					...
					<input type="text" name="subscription_for" value="GYM"  placeholder="GYM/TRAINER">
					...
					<input type="text" name="start_date" value="" placeholder="Start Date">
		...
		<div class="flex-center position-ref full-height">
            <div class="content">
				...
				<form method="post" action="http://perfectlinkfitness.com/api/subscription-payment">
					...
					<input type="text" name="discount_id" value="10" placeholder="Discount Id">
					<input type="text" name="start_date" value="" placeholder="Start Date">
					<input type="text" name="preferred_time" value="" placeholder="Preferred Time">
					<input type="submit" name="paynow" value="Pay Now">
				</form>
            </div>
        </div>
