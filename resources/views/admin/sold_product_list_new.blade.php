                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="sub_title" data-editable="true">Sub Title</th>
	...
	<form method="post" action="{{URL::to('/admin/add_tracking_details')}}">
		...
		<div class="row" style="margin-bottom:10px;">
			...
			<div class="col-sm-7">
				...
				<input type="hidden" class="form-control" name="accessorie_id" value="{{$product->product_id}}" required>
...
@endif
											...
											<button data-toggle="tooltip" title="Shipping Address" class="pd-setting-ed" style="float: left;width: 42%;">
											...
											@if(empty($product->tracking_details))
											<button data-toggle="tooltip" title="Add Shipping Details" class="pd-setting-ed" style="float: left;width: 42%;">
											...
											@else
											<button data-toggle="tooltip" title="Tracking Details" class="pd-setting-ed" style="float: left;width: 42%;">
