...
@section('breadcrumbs-title',"Add Page")
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="review-content-section">
										<div id="dropzone1" class="pro-ad addcoursepro">
											<form method="post" action="{{URL::to('/admin/add_page')}}" enctype="multipart/form-data" class="" id="demo1-upload">
												{{ csrf_field() }}
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														<div class="form-group">
															<input name="page_name" type="text" class="form-control" placeholder="Page Name for Left Panel">
														</div>
														<div class="form-group">
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														...
														<div class="form-group">
															...
															<textarea id="summernote1" rows="6" name="brief_description" placeholder="Brief Description"></textarea>
														</div>
														<div class="form-group">Full Description</div>
														<div class="form-group">
															<!--<textarea name="full_description" placeholder="Full Description"></textarea>-->
															<textarea id="summernote2" rows="6" name="full_description" placeholder="Full Description"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
